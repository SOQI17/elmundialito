...
interface LeagueSelectorProps {
  ...
  onSavePaymentSettings?: (bankConfig: League['bankConfig'], costPerEntry: number, gameMode?: League['gameMode'], customGroups?: League['customGroups'], poolDistributionMode?: League['poolDistributionMode']) => Promise<void>;
