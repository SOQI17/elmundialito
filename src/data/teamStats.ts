...
export const TEAM_STATS: Record<string, TeamStatistics> = {
  MEX: {
    ...
    ultimosPartidos: [
      ...
      { date: '2026-03-28', opponent: 'Portugal', score: '2-2', result: 'E' },
  ...
  RSA: {
    ...
    racha: ['P', 'E', 'P', 'G', 'P'],
    ultimosPartidos: [
      { date: '2026-03-31', opponent: 'Camerún', score: '1-2', result: 'P' },
      { date: '2026-03-27', opponent: 'Zimbabue', score: '3-2', result: 'G' },
      { date: '2026-01-04', opponent: 'Camerún', score: '1-2', result: 'P' },
      { date: '2025-12-29', opponent: 'Zimbabue', score: '3-2', result: 'G' },
      { date: '2025-11-22', opponent: 'Egipto', score: '0-1', result: 'P' }
    ]
  },
  CZE: {
    id: 'CZE',
  ...
  USA: {
    ...
    ultimosPartidos: [
      ...
      { date: '2025-10-14', opponent: 'Austria', score: '4-0', result: 'G' }
    ]
  },
  PAR: {
    id: 'PAR',
  ...
  CUW: {
    ...
    ultimosPartidos: [
      ...
      { date: '2025-10-14', opponent: 'Trinidad y Tobago', score: '1-1', result: 'E' }
    ]
  },
  NED: {
    id: 'NED',
  ...
  KSA: {
    ...
    ultimosPartidos: [
      ...
      { date: '2025-12-18', opponent: 'Jordania', score: '0-0', result: 'E' },
  ...
  AUT: {
    ...
    ultimosPartidos: [
      ...
      { date: '2025-11-15', opponent: 'Chipre', score: '2-0', result: 'G' }, // wait, P-P? Ah! The image shows racha G-G-G-P-P. Wait, let's adjust:
  ...
  JOR: {
    ...
    ultimosPartidos: [
      ...
      { date: '2026-03-27', opponent: 'Costa Rica', score: '2-2', result: 'E' },
  ...
  POR: {
    ...
    ultimosPartidos: [
      ...
      { date: '2026-03-28', opponent: 'México', score: '0-2', result: 'P' },
  ...
  UZB: {
    ...
    ultimosPartidos: [
      ...
      { date: '2026-01-03', opponent: 'China', score: '2-0', result: 'G' },
